...
public class GetAppResponse {
    ...
    private AppServiceResponse service_response;
    ...
    public AppServiceResponse getService_response() {
        return service_response;
    }

    public void setService_response(AppServiceResponse service_response) {
