...
public class SwitchCompatEx extends SwitchCompat {
    ...
    public int TRACK_LABEL_SIZE = sp2Px(Global.width<=480?14f:(Global.width<=640?11f:((Global.width<=720||Global.width<=1080||Global.width<=1440)?11f:12f)));

    public int THUMB_COLOR = 0xFFEBEBEB;
    public int THUMB_LABEL_COLOR = 0xFFa31533;
    public int THUMB_LABEL_SIZE = sp2Px(Global.width<=480?14f:(Global.width<=640?11f:((Global.width<=720||Global.width<=1080||Global.width<=1440)?11f:12f)));
