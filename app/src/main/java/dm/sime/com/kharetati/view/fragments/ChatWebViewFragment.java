...
public class ChatWebViewFragment extends Fragment {
    ...
    public static ChatWebViewFragment newInstance(String url, String appName){
        ChatWebViewFragment fragment = new ChatWebViewFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Global.current_fragment_id = FragmentTAGS.FR_CHAT_WEBVIEW;
        ...
        View view = inflater.inflate(R.layout.fragment_chat_webview, container, false);
